...
const Sidebar = () => {
  ...
  const navItems = [
    { icon: <IoHome size={18} />, label: 'Overview', path: '/dashboard' },
    // { icon: <FaLayerGroup size={16} />, label: 'Banner', path: '/banner' },
    { icon: <FaRegEnvelope size={16} />, label: 'Chat', path: '/messages' },
    { icon: <FaUserFriends size={16} />, label: 'User Controls', path: '/userControls' },
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 h-screen w-60 bg-white shadow-md border-r border-gray-200
