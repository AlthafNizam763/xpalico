  ...
  return (
    <header className="box-border flex relative justify-between items-center px-30 pt-5 pb-1 w-full bg-neutral-900 max-md:px-14 max-md:pt-8 max-md:pb-4 max-sm:flex-row max-sm:justify-between max-sm:px-5 max-sm:py-4">
      <div className="flex gap-1 justify-center items-center p-3 rounded-[100px]">
        ...
        <span className="text-base font-serif tracking-wide text-white">MoRe Experts</span>
      </div>

      <nav className="flex absolute left-2/4 gap-6 items-start -translate-x-2/4 max-md:hidden max-sm:hidden">
        <a href="#" className="text-base font-mono tracking-wide leading-5 cursor-wait text-neutral-400 hover:text-[#6DE754] transition">Resume</a>
        <a href="#" className="text-base font-mono tracking-wide leading-5 cursor-wait text-neutral-400 hover:text-[#6DE754] transition">Poster</a>
        <a href="#" className="text-base font-mono tracking-wide leading-5 cursor-wait text-neutral-400 hover:text-[#6DE754] transition">Website</a>
      </nav>
